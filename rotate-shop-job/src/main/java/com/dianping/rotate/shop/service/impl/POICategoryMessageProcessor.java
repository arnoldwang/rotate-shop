 ...
 */
public class POICategoryMessageProcessor implements MessageProcessor {
    ...
    public void process(){
        while(Switch.on()){
            List<MessageEntity> messages = messageQueueDAO.getMessage(MessageSource.PERSON, POIMessageType.SHOP_CATEGORY,PROCESS_MESSAGE_LIMIT);
