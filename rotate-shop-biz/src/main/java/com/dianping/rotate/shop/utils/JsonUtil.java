...
public class JsonUtil {
    ...
    static {
        ...
        MAPPER.getDeserializationConfig().set(DeserializationConfig.Feature.USE_GETTERS_AS_SETTERS, false);
    }
    ...
    public static Map<String, String> strToMap(String content) throws IOException {
        return fromStr(content, Map.class);
    }
